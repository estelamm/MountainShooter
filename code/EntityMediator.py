...
class EntityMediator:
    ...
    def __verify_collision_entity(ent1, ent2):
        valid_interaction = False  # começa como falsa
        if isinstance(ent1, Enemy) and isinstance(ent2,
                                                  PlayerShot):  # verificando se ent1 é do tipo Enemy e 2 do tipo PlayerShot
    ...
    def verify_collision(entity_list: list[Entity]):  # criando entidades
        for i in range(len(entity_list)):  # iterando entidades
            ...
            EntityMediator.__verify_collision_window(entity1)  # novo metodo
